...
out_msh = Path("naca4412_v9_grid_FINE.msh")
out_png = Path("naca4412_v9_grid_FINE_preview.png")
...
# Mesh resolution
# -----------------------------
n_nose_half = 280         # split -> LE and LE -> split
n_airfoil_upper = 600     # split -> TE
n_transition = 60         # TE -> wake throat
n_wake = 640              # shared wake centreline -> outlet, V12
